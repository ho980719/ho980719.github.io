      ...
      <div className='row op0' id='productInfo' style={{transition: '1.5s'}}>
        ...
        <div className='col-md-6'>
          ...
          <button
            ...
            onClick={() => {
              dispatch(addCart({id: 3, name: 'Text...', qty: 2, price: 10000, totalPrice: 20000}))
            }}
          >
            장바구니
          </button>
        ...
        <Nav fill variant="tabs" defaultActiveKey="link-0" className='product-tab'>
          <Nav.Item>
            <Nav.Link eventKey="link-0" onClick={() => {setTabIndex(0)}}>상품설명</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="link-1" onClick={() => {setTabIndex(1)}}>상품평</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="link-2" onClick={() => {setTabIndex(2)}}>상품문의</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="link-3" onClick={() => {setTabIndex(3)}}>배송/교환/반품 안내</Nav.Link>
          </Nav.Item>
        </Nav>
