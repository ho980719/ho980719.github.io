...
function App () {
  ...
  const clickCheck = () => {
    return click < 2 ? <button style={{width:'50%', padding:20, margin:20}} type='button' onClick={()=>{ setClick(click + 1) }}>버튼임</button> : null
  }
  ...
  return (
    <div className='App'>
      ...
      <div className='container' id='container'>
        <Routes>{}
          <Route path='/' element={<ProductList products={products} navigate={navigate} clickCheck={clickCheck} />}/>
      ...
      <Container>
        ...
        <Navbar.Collapse id='responsive-navbar-nav'>
          <Nav className='me-auto'>
            ...
            <Nav.Link href='/event/one'>Event</Nav.Link>
...
function ProductCard(props) {
  return(
    <div style={{ width: '18rem'}} className='mt-4'>
      ...
      onClick={()=> {props.navigate(`/detail/${props.product.id}`)}}>
